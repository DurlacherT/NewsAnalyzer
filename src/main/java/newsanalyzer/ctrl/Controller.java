...
public class Controller {
	...
	public static final String APIKEY = "9573e76e4f99415fb724fede7635963a";

	public static final String pageSize = "100";

	public String process(String q) throws NewsException, IOException {
	...
	public List<Article> getData(NewsApi newsApi) throws NewsException, IOException {
